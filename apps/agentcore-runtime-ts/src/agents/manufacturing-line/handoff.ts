...
export function buildManufacturingLineAgentHandoffPrompt(
  ...
  parts.push(
    ...
    '- answer must be a concise natural-language response: target under 800 output tokens, lead with the conclusion, and use at most 3-6 short bullet points for key facts',
    '- do not embed full procedure steps, full runbooks, or long quoted passages in answer; reference the source document via citations and keep only the essential summary inline',
    '- omit safety notices, recovery procedures, and background sections from answer by default; place follow-up steps in nextActions and risks or unknowns in caveats',
